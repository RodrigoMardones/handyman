 ...
 */
export async function retrieveTopK(question, docs, k = DEFAULT_TOP_K) {
 ...
 */
export function composeAskSystem() {
    return [
 ...
 * refs it was given. */
export function composeAskPrompt(question, fragments) {
    const lines = [];
 ...
 */
export async function relayAsk(options) {
