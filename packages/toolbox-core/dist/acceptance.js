...
export function composeAcceptanceSystem() {
    return [
...
export function composeAcceptancePrompt(source, content, truncated) {
    const header = source === "diff"
 ...
 */
export function lastBulletIsGreenGate(md) {
    const bullets = md
        .split("\n")
        .map((line) => line.trim())
...
export async function relayAcceptance(options) {
